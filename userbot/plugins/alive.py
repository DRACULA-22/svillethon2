...
DEFAULTUSER = ALIVE_NAME or "svillethon"
ICSS_IMG = Config.ALIVE_PIC or "https://telegra.ph/243343243-05-09"
ICSS_TEXT = Config.CUSTOM_ALIVE_TEXT or "𓆩 𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 svillethon 𓆪"
...
async def ica(icss):
    ...
    if ICSS_IMG:
        ...
        ics_c += f"**{ICSEM} اصدار سفيلثون ↫** `{icsv}`\n"
        ics_c += f"**{ICSEM} اصدار البايثون ↫** `{python_version()}\n`"
        ics_c += f"**{ICSEM} المستخدم ↫** {mention}\n"
        ics_c += f"**{ICSEM} مطور السورس ↫** [اضغط هنا](t.me/svillethon) 𓆰.\n"
        ics_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
