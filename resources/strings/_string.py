...
DEFAULTUSER = str(Name) if Name else "svillethon Userbot"
...
Start = (
    """
    <------------------------------------>
         يتم تحميل ملفات السورس سفيلثون
    <------------------------------------>
    """
)
...
C = "**⌔∮ المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 svillethon - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
    "**⌔∮ قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
    "𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 svillethon - [𝘿𝙀𝙑](t.me/svillethon) 𓆪"
)
...
StartLoaded = "<ⵧⵧⵧⵧⵧⵧ⫷ - svillethon PLUGINS - ⫸ⵧⵧⵧⵧⵧⵧ>"
ASSISTANT = "<ⵧⵧⵧⵧⵧⵧ⫷ - svillethon ASSISTANT - ⫸ⵧⵧⵧⵧⵧⵧ>"
KIMOTOSHA = "<ⵧⵧⵧⵧⵧⵧⵧⵧ⫷ - svillethon TOSHA - ⫸ⵧⵧⵧⵧⵧⵧⵧ>"
ANIMATIONS = "<ⵧⵧⵧⵧⵧⵧ⫷ - svillethon ANIMATIONS - ⫸ⵧⵧⵧⵧⵧ>"
ADMIN = "<ⵧⵧⵧⵧⵧ⫷ - svillethon ADMIN TOOLS - ⫸ⵧⵧⵧⵧⵧ>"
ASSISTANTPM = "<ⵧⵧⵧⵧⵧ⫷ - svillethon ASSISTANT PM - ⫸ⵧⵧⵧⵧⵧ>"
...
Message = (
"""       ⫷ بوت سفيلثون يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
⫷ @svillethon - اذا كنت بحاجه الى مساعده فتوجه الى ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين سفيلثون ⫸',
    '⫷ اكتمل تنزيل انلاين سفيلثون بدون اخطاء ⫸',
    '⫷ يتم بدء بوت سفيلثون ⫸',
    '⫷ اكتمل بدء بوت سفيلثون ⫸'
]
...
Echo = [
    ...
    '𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 svillethon - 𝑬𝑪𝑯𝑶 𝑳𝑰𝑺𝑻 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⌔∮ قائمة المضافين للازعاج:**\n',
    '**- ايدي المستخدم :** `{}`\n**- ايدي الـمجموعه :** `{}`\n\n',
